...
rise_up_october = open('../../Downloads/RiseUpOctober1000', 'r')
...
rise_up_users = open('rise_up_users1000.json', 'w')
rise_up_tweets = open('rise_up_tweets1000.json', 'w')
rise_up_hashtags = open('rise_up_hashtags1000.json', 'w')
